TRUNCATE "public".cs_dynamic_children_helper;

INSERT INTO "public".cs_dynamic_children_helper ("name", code) 
	VALUES ('CidsObjects(class_id varchar, table_name varchar)', 'SELECT -1 AS id,
 	null AS name,
...
INSERT INTO "public".cs_dynamic_children_helper ("name", code) 
	VALUES ('Entities(level_id integer, hydroCon_id integer)', 'SELECT DISTINCT -1 AS id,
...
INSERT INTO "public".cs_dynamic_children_helper ("name", code) 
	VALUES ('collectionsExternal(collection_id integer)', 'SELECT -1 AS id,
	resource.name AS name,
	cs_class.id AS class_id,
	resource.id AS object_id,
	''O'' AS node_type,
...
INSERT INTO "public".cs_dynamic_children_helper ("name", code) 
	VALUES ('tags(taggroup_id integer)', 'SELECT 
  -1 as id, 
	tag.name, 
	cs_class.id as class_id, 
	tag.id as object_id, 
