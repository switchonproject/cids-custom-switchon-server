...
CREATE INDEX data_table_index_anytext ON pycsw.data_table USING gin(to_tsvector('english', anytext));
CREATE INDEX data_table_index_keywords ON pycsw.data_table USING gin(to_tsvector('english', keywords));
