...
USR="switchon"    
PWD=""
SHP="ECAD_prec_stations"
LYR="ECAD:ECAD_prec_stations"
RES="178"    
...
ogr2ogr -progress --config PG_USE_COPY YES -f PostgreSQL PG:"host=127.0.0.1 port=5432 dbname=$DB password=$PWD user=$USR" -lco DIM=2 $SHP.shp -overwrite -lco OVERWRITE=YES -t_srs "EPSG:4326" -a_srs "EPSG:4326" -lco SCHEMA=import_tables -lco GEOMETRY_NAME=geom -nln geosearch_import -gt 65536
